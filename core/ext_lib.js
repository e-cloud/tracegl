...
define(function (require, exports) {
    ...
    e.i1 = function () {
        clamp(step(0, -n.a1) + (u - n.t1) / n.a1, 0, 1)
    }
    e.i2 = function () {
        clamp(step(0, -n.a2) + (u - n.t2) / n.a2, 0, 1)
    }
    e.i3 = function () {
        clamp(step(0, -n.a3) + (u - n.t3) / n.a3, 0, 1)
    }
    e.i4 = function () {
        clamp(step(0, -n.a4) + (u - n.t4) / n.a4, 0, 1)
    }
    e.i5 = function () {
        clamp(step(0, -n.a5) + (u - n.t5) / n.a5, 0, 1)
    }
    e.i6 = function () {
        clamp(step(0, -n.a6) + (u - n.t6) / n.a6, 0, 1)
    }
    e.i7 = function () {
        clamp(step(0, -n.a7) + (u - n.t7) / n.a7, 0, 1)
    }
    e.i8 = function () {
        clamp(step(0, -n.a8) + (u - n.t8) / n.a8, 0, 1)
    }
    e.i9 = function () {
        clamp(step(0, -n.a9) + (u - n.t9) / n.a9, 0, 1)
    }
