    ...
    pp$1.parseForStatement = function (node) {
        ...
        if (this.type === tt._var || this.type === tt._const || isLet) {
            ...
            if ((this.type === tt._in || (this.options.ecmaVersion >= 6 && this.isContextual("of"))) &&
                init$1.declarations.length ===
                1 && !(kind !== "var" && init$1.declarations[0].init)) {
        ...
        for (; ;) {
            ...
            if (this$1.eat(tt.eq)) {
                decl.init = this$1.parseMaybeAssign(isFor)
                       ...
                       "const" &&
                       !(this$1.type === tt._in || (this$1.options.ecmaVersion >= 6 && this$1.isContextual("of")))) {
                this$1.unexpected()
            } else if (decl.id.type !=
                       "Identifier" && !(isFor && (this$1.type === tt._in || this$1.isContextual("of")))) {
    ...
    pp$1.parseClass = function (node, isStatement) {
        ...
        while (!this.eat(tt.braceR)) {
            ...
            if (this$1.options.ecmaVersion >=
                8 && !isGenerator && !method.computed &&
                method.key.type ===
                "Identifier" &&
                method.key.name ===
                "async" &&
                this$1.type !==
                tt.parenL && !this$1.canInsertSemicolon()) {
                isAsync = true
                this$1.parsePropertyName(method)
            }
            method.kind = "method"
        ...
        if (this.shouldParseExportStatement()) {
            ...
            if (this.eatContextual("from")) {
                ...
                for (var i = 0; i < node.specifiers.length; i++) {
                    if (this$1.keywords.test(node.specifiers[i].local.name) ||
        ...
        while (!this.eat(tt.braceR)) {
            ...
            if (this$1.eatContextual("as")) {
                ...
                if (this$1.reservedWordsStrict.test(node$2.local.name)) {
                    this$1.raiseRecoverable(node$2.local.start, "The keyword '" +
                                                                node$2.local.name +
                                                                "' is reserved")
                }
            }
...
// Parses spread element.
    ...
    pp$2.parseRest = function (allowNonIdent) {
        ...
        if (allowNonIdent) {
            ...
            node.argument = this.type ===
                            tt.name ||
                            this.type ===
                            tt.bracketL ? this.parseBindingAtom() : this.unexpected()
        }
        ...
        switch (expr.type) {
            case "Identifier":
                if (this.strict && this.reservedWordsStrictBind.test(expr.name)) {
                    this.raiseRecoverable(expr.start, (isBinding ? "Binding " : "Assigning to ") +
                                                      expr.name +
                                                      " in strict mode")
                }
                if (checkClashes) {
...
// Parse call, dot, and `[]`-subscript expressions.
    ...
    pp$3.parseExprSubscripts = function (refDestructuringErrors) {
        ...
        var skipArrowSubscripts = expr.type ===
    ...
    pp$3.parseSubscripts = function (base, startPos, startLoc, noCalls) {
        ...
        for (; ;) {
            var maybeAsyncArrow = this$1.options.ecmaVersion >=
                                  8 &&
                                  base.type ===
                                  "Identifier" &&
                                  base.name ===
                                  "async" && !this$1.canInsertSemicolon()
            if (this$1.eat(tt.dot)) {
                ...
                this$1.yieldPos = 0
                this$1.awaitPos = 0
                var exprList = this$1.parseExprList(tt.parenR, this$1.options.ecmaVersion >=
                                                               8, false, refDestructuringErrors)
...
// Parse function body and check parameters.
    ...
    pp$3.parseFunctionBody = function (node, isArrowFunction) {
        ...
        var useStrict = (!isExpression &&
                         ...
                         this.isUseStrict(node.body.body[0])) ? node.body.body[0] : null
...
// Token-specific context update code
    ...
    tt._function.updateContext = function (prevType) {
        if (prevType.beforeExpr &&
            ...
            tt.semi &&
            prevType !==
            tt._else && !((prevType === tt.colon || prevType === tt.braceL) && this.curContext() === types.b_stat)) {
        ...
        try {
            ...
            if (throwErrorAt !== undefined) {
                if (e instanceof SyntaxError) {
                    parser.raise(throwErrorAt, "Error parsing regular expression: " +
                                               e.message)
                }
                throw e
            }
