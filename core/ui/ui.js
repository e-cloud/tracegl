...
define(function (require) {
    ...
    (function (p) {
        ...
        function vs(k, d) {
            ...
            p.__defineSetter__(k, function (v) {
                ...
                if (this._9) {
                    // already initialized, check vb or call update
    ...
    ui.update = function (n) {
        ...
        for (const i in vt) {
            ...
            if (ln) {
                // if we dont have a lookup, its an internal attribute
    ...
    ui.view = function(n, v = {}) {
        v.x = gl.eval(n, n._x, uni, el), v.y = gl.eval(n, n._y, uni, el), v.w = gl.eval(n, n._w, uni, el), v.h = gl.eval(n, n._h, uni, el);
        return v;
    };
    // |  view computation
    // \____________________________________________/
    ui.inner = function(n, v = {}) {
        v.x = gl.eval(n, n.x_, uni, el), v.y = gl.eval(n, n.y_, uni, el), v.w = gl.eval(n, n.w_, uni, el), v.h = gl.eval(n, n.h_, uni, el);
        return v;
    };
    ...
    ui.draw = function () {
        ...
        try {
            // catch all exceptions in events
            ...
            // implement move
            if (n) {
                // && (lm_x != gl.mouse_x || lm_y != gl.mouse_y)){
    ...
    ui.drawer = function () {
        ui.redraw();
        gl.mouse_p(function () {
            md = 1, ui.md = 1, gl.anim(ui.draw);
        });
        gl.mouse_m(function () {
            gl.anim(ui.draw);
        });
        gl.mouse_r(function () {
            md = 0, ui.md = 0, gl.anim(ui.draw);
        });
        gl.mouse_s(function () {
            ms = 1, gl.anim(ui.draw);
        });
        gl.mouse_u(function () {
            dc = 1, gl.anim(ui.draw);
        });
