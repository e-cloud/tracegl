    ...
    exports.cursors = function(b, opt = {}) {
        ...
        function cursor() {
            ...
            if (p.len) {
                ...
                c = Object.create(cursor.prototype);
            }
        ...
        b.u = function () {
            if (!ui.ms.m) {
                // clear cursors if not holding meta
                b.vcs.clear();
                cmc = b.vcs.new();
            } else {
                // grab last cursor created
            ...
            while (t) {
                ...
                if (y >= j && v <= j + l) {
                    ...
                    for (let i = fn.max(0, v - j); i + j <= y && i < l; i++) {
                        ...
                        po = o + 3;
                        r[o] = x1, r[o + 1] = y1, r[o + 2] = x2, r[o + 3] = fl, e[o] = x1, e[o + 1] = y1, o += s;
                        r[o] = x1, r[o + 1] = y1, r[o + 2] = x2, r[o + 3] = fl, e[o] = x2, e[o + 1] = y1, o += s;
                        r[o] = x1, r[o + 1] = y1, r[o + 2] = x2, r[o + 3] = fl, e[o] = x1, e[o + 1] = y2, o += s;
                        r[o] = x1, r[o + 1] = y1, r[o + 2] = x2, r[o + 3] = fl, e[o] = x2, e[o + 1] = y1, o += s;
                        r[o] = x1, r[o + 1] = y1, r[o + 2] = x2, r[o + 3] = fl, e[o] = x1, e[o + 1] = y2, o += s;
                        r[o] = x1, r[o + 1] = y1, r[o + 2] = x2, r[o + 3] = fl, e[o] = x2, e[o + 1] = y2, o += s;
                        pf = fl;
                        p1 = x1;
                        p2 = x2;
                        c.vb.hi++;
